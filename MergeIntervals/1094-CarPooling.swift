...
func carPooling(_ trips: [[Int]], _ capacity: Int) -> Bool {
    ...
    var heap = Heap<(passenger: Int, end: Int)>{ $0.end < $1.end }
    ...
    for trip in trips {
        ...
        while !heap.isEmpty,
                let prevTrip = heap.peek(),
                startTime >= prevTrip.end {
            currentPassenger -= heap.remove()!.passenger
        }

        currentPassenger += passenger
        heap.insert((passenger, endTime))
